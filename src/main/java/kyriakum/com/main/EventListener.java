    ...
    public void onMessageReceived(MessageReceivedEvent e){
        ...
        if(args[0].equalsIgnoreCase("!link")){
            ...
            if(main.getLinkManager().userExists(e.getAuthor())){
                e.getChannel().sendMessage(e.getAuthor().getAsMention() + " you are already verified!").queue();
            } else {
                e.getChannel().sendMessage(e.getAuthor().getAsMention() + " you are not verified!").queue();
